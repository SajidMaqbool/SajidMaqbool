...
- 🔗 **Focus:** Solana Blockchain, Rust, Anchor, Web3
...
- 💼 Web3 Student Projects & Hackathons
...
- 🌙 I deploy smart contracts at midnight (night owl developer) 🦉
...
|---------|-------------|------------|
| 🆔 **solana-umt-passport** | A decentralized identity (DID) system for UMT Lahore students built on Solana Blockchain using Rust and Anchor framework | Rust, Anchor, Solana |
| 💼 **Sajid-Maqbool** | My personal portfolio website | HTML, CSS |
| 💰 **ewallet-project** | Digital Wallet System with Expense Tracking - FastAPI Backend | Python, FastAPI |
| 🛂 **solana-passport** | Proof of Personhood on Solana - Decentralized identity verification | Rust, Solana, Anchor |
| ⚙️ **SajidMaqbool** | GitHub profile configuration files | Jupyter Notebook, Config |
...
⭐️ *Building the future of decentralized identity on Solana!* ⭐️
